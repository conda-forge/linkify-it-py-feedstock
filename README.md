...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/linkify-it-py-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11484&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/linkify-it-py-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `linkify-it-py` can be installed with:

```
conda install linkify-it-py
```

It is possible to list all of the versions of `linkify-it-py` available on your platform with:
