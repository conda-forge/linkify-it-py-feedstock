...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/linkify-it-py-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/linkify-it-py-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add linkify-it-py
# for installing globally
pixi global install linkify-it-py
```
...
It is possible to list all of the versions of `linkify-it-py` available on your platform:
...
```
pixi search linkify-it-py --channel conda-forge
```
